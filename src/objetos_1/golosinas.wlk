//de cada golosina: si tiene gluten,precio,sabor,peso.
...
//supongo que antes de morderlo nose que gusto tiene, por ende utilizo el null
object tuttifrutti {
	...
	method mordisco(){
		gustoActual = gustosPosibles.first()
		gustosPosibles.remove(gustoActual)
		gustosPosibles.add(gustoActual)
    }
	method gusto(){
		return gustoActual
	}
